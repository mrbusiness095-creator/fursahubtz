...
export function CustomerServiceButton() {
  return (
    <a
      ...
      className="fixed right-4 bottom-24 z-40 flex items-center gap-2 rounded-full bg-gradient-green px-4 py-3 text-sm font-bold text-primary-foreground shadow-float"
    >
