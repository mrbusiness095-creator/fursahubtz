  ...
  return (
    <AppShell>
      ...
      <main className="-mt-6 space-y-3 px-4 pb-8">
        ...
        <section className="rounded-3xl bg-card p-5 shadow-card"><h2 className="font-extrabold text-foreground">Taarifa za akaunti</h2><div className="mt-3 space-y-2 text-sm"><Row label="Username" value={user.username} /><Row label="Simu" value={user.phone} /><Row label="Email" value={user.email} /><Row label="Activation" value={`TZS ${user.activationFee.toLocaleString()} · PAID`} /></div></section>
      </main>
